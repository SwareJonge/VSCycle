...
void inline PrimariesToBT709(sycl::float3 a);

template<>
void inline PrimariesToBT709<AVCOL_PRI_BT709>(sycl::float3 a){

}

//https://www.itu.int/dms_pub/itu-r/opb/rep/R-REP-BT.2407-2017-PDF-E.pdf
template<>
void inline PrimariesToBT709<AVCOL_PRI_BT2020>(sycl::float3 a){
    const f32 x = a.x();
    const f32 y = a.y();
    const f32 z = a.z();
